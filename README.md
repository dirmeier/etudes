...
- [Bayesian filtering](https://nbviewer.jupyter.org/github/dirmeier/etudes/blob/master/bayesian-filtering.ipynb) introduces recursive estimation using the Kalman and particle filters.
...
## Études on machine learning learning
