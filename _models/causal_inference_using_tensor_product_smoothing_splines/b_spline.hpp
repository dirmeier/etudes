...
namespace b_spline_model_namespace {
...
{" (found before start of program)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 20, column 2 to column 20)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 21, column 2 to column 23)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 22, column 2 to column 22)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 36, column 2 to column 18)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 37, column 2 to column 17)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 26, column 2 to column 27)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 27, column 2 to column 23)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 29, column 6 to column 40)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 28, column 22 to line 30, column 3)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 28, column 2 to line 30, column 3)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 32, column 2 to column 28)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 4, column 2 to column 17)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 5, column 9 to column 10)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 5, column 2 to column 14)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 6, column 9 to column 10)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 6, column 2 to column 14)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 8, column 2 to column 22)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 9, column 2 to column 23)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 10, column 9 to column 16)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 10, column 2 to column 24)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 14, column 2 to column 36)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 15, column 9 to column 10)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 15, column 12 to column 18)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 15, column 2 to column 58)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 20, column 9 to column 15)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 36, column 9 to column 10)",
 " (in '/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/functions.stan', line 3, column 16, included from\n'/home/simon/PROJECTS/_etudes/_models/causal_inference_using_tensor_product_smoothing_splines/b_spline.stan', line 1, column 0)",
...
class b_spline_model final : public model_base_crtp<b_spline_model> {
 ...
 private:
  ...
  int degree;
  int n_knots;
  Eigen::Matrix<double, -1, 1> knots__;
  int n_coef;
 ...
 public:
  ...
  inline std::string model_name() const final { return "b_spline_model"; }
  ...
  b_spline_model(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ = "b_spline_model_namespace::b_spline_model";
    ...
    try {
      ...
      knots__ = Eigen::Matrix<double, -1, 1>(n_knots);
      new (&knots) Eigen::Map<Eigen::Matrix<double, -1, 1>>(knots__.data(), n_knots);
      ...
      
      {
        ...
        for (int sym1__ = 1; sym1__ <= n_knots; ++sym1__) {
          current_statement__ = 20;
          assign(knots, knots_flat__[(pos__ - 1)],
            "assigning variable knots", index_uni(sym1__));
          current_statement__ = 20;
          pos__ = (pos__ + 1);
        }
      }
      ...
      validate_non_negative_index("B", "n_coef", n_coef);
      current_statement__ = 24;
      B__ = Eigen::Matrix<double, -1, -1>(N, n_coef);
      new (&B) Eigen::Map<Eigen::Matrix<double, -1, -1>>(B__.data(), N, n_coef);
      stan::math::fill(B, std::numeric_limits<double>::quiet_NaN());
      
      current_statement__ = 24;
      assign(B, bspline(X, n_coef, degree, knots, pstream__),
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "b_spline_model_namespace::log_prob";
    (void) function__;  // suppress unused var warning
    
    try {
      Eigen::Matrix<local_scalar_t__, -1, 1> mu;
      mu = Eigen::Matrix<local_scalar_t__, -1, 1>(n_coef);
      stan::math::fill(mu, DUMMY_VAR__);
      
      current_statement__ = 1;
      mu = in__.template read<Eigen::Matrix<local_scalar_t__, -1, 1>>(n_coef);
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "b_spline_model_namespace::write_array";
    (void) function__;  // suppress unused var warning
    
    try {
      Eigen::Matrix<double, -1, 1> mu;
      mu = Eigen::Matrix<double, -1, 1>(n_coef);
  ...
  inline std::string get_constrained_sizedtypes() const {
    ...
    return std::string("[{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n_coef) + "},\"block\":\"parameters\"},{\"name\":\"mu_tau\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"sigma\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"y_hat\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N) + "},\"block\":\"generated_quantities\"}]");
  ...
  inline void transform_inits(const stan::io::var_context& context,
     ...
     constexpr std::array<const char*, 3> names__{"mu", "mu_tau", "sigma"};
      const std::array<Eigen::Index, 3> constrain_param_sizes__{n_coef, 
       1, 1};
...
using stan_model = b_spline_model_namespace::b_spline_model;
...
stan::math::profile_map& get_stan_profile_data() {
  return b_spline_model_namespace::profiles__;
}
