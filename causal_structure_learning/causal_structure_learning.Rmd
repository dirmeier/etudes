...
Some useful references are [@peters2017elements,@drton2017structure,@heinze2018causal]. Feedback and comments are welcome!
...
bn.ges.cpdag + ggtitle("GES CPDAG")
```
...
```{r}
bn.gnn <- train(X, n_epochs = 10000, c=1000000, lambda=1000000, learning_rate=0.1)
```
...
bn.daggnn.cpdag + ggtitle("DAG-GNN CPDAG")
```
